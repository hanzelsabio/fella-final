    ...
    <section id="contact-section" className="contact_section text-center">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="John"
                    className="w-full border text-gray-700 border-gray-400 px-8 py-3.5 focus:outline-none"
                  />
                  {errors.first_name && (
                ...
                <div>
                  ...
                  <input
                    ...
                    readOnly
                    className="w-full border font-semibold text-gray-700 border-gray-400 px-8 py-3.5 focus:outline-none"
                  />
                  {errors.product && (
                    <p className="text-red-500 text-sm mt-1">
                      {errors.product}
      ...
      {showModal && (
        <div
          ...
          onClick={closeModal}
        >
          <div className="bg-white p-8 md:px-20 py-8 shadow-xl max-w-lg text-center relative animate-fadeIn">
            {/* <button
            ...
            <Button
              onClick={closeModal}
              className="bg-black hover:bg-gray-800 mt-6"
            >
              Close
            </Button>
          </div>
